...
describe('Turn Class', () => {
  ...
  it('the current card should be an instance of the card class', () => {
    const card32 = new Card (
      32,
      'What year did BTS debut?',
      ['2012', '2013', '2014'],
  ...
  it('should store any card as the current card', () => {
    const card47 = new Card (
      47,
      'What is the name of the Chinese Drama Eternal Love female protagonist?',
      ['Fengjiu', 'Yehua', 'Baiqian'],
      'Baiqian')
  ...
  it('should be able to return the users guess', () => {
    ...
    expect(turn.returnGuess()).to.deep.equal(
  ...
  it('should be able to accurately evaluate the users guess', () => {
    const card32 = new Card (
      32,
      'What year did BTS debut?',
      ['2012', '2013', '2014'],
  ...
  it('should be able give accurate feedback', () => {
    const card32 = new Card (
      32,
      'What year did BTS debut?',
      ['2012', '2013', '2014'],
